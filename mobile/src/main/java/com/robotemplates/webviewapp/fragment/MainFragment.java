...
public class MainFragment extends TaskFragment implements SwipeRefreshLayout.OnRefreshListener, AdvancedWebView.Listener {
    ...
    public void onResume() {
        super.onResume();
        musicPlayerBtn.setVisibility(View.VISIBLE);
        mWebView.onResume();
    }
...
//TODO music btn
        musicPlayerBtn = getActivity().findViewById(R.id.music_player_btn);
        musicPlayerBtn.setOnClickListener(view -> startMusicFragment());
    ...
    //TODO start music fragment
    private void startMusicFragment() {
        musicPlayerBtn.setVisibility(View.INVISIBLE);
        Fragment musicFragment = new MusicFragment();
        FragmentManager fragmentManager = requireActivity().getSupportFragmentManager();
        fragmentManager.beginTransaction()
                .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE)
                .replace(R.id.container_drawer_content, musicFragment).addToBackStack(null).commitAllowingStateLoss();
    }
